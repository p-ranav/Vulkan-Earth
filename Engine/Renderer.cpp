...
VkImageView Engine::Renderer::CreateImageViewHelper(VkImage image, VkFormat format)
{
...
void Engine::Renderer::CreateImageViews()
{
	...
	for (uint32_t i = 0; i < swapChainImages.size(); i++) {
		swapChainImageViews[i] = CreateImageViewHelper(swapChainImages[i], swapChainImageFormat);
	}
}
...
{
	textureImageView = CreateImageViewHelper(textureImage, VK_FORMAT_R8G8B8A8_UNORM);
}
